  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="grid items-center gap-10 md:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <p className="text-base leading-7 text-brand-muted sm:text-lg">
            ...
            progress through your own campus saga.
          </p>
      ...
      <section id="features" className="mt-14 border-t border-black/5 pt-10">
        <h2 className="text-xl font-semibold text-brand-ink">Website features</h2>
      ...
      <section id="security" className="mt-14 border-t border-black/5 pt-10">
        <h2 className="text-xl font-semibold text-brand-ink">Security basics</h2>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-brand-muted">
          This demo uses server-side validation, hashed passwords, secure session
          cookies, rate limiting on auth/top up endpoints, and common security
          headers to reduce typical web risks.
        </p>
      </section>
    </div>
  );
